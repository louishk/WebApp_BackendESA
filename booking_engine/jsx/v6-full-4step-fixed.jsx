      ...
      <div style={{ display: "flex", flexDirection: mob ? "column" : "row", gap: 14 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 7, marginTop: 14 }}>
            <button onClick={function() { setAct("pay"); }} style={{ padding: "13px 0", borderRadius: 11, border: "none", background: R, color: "#fff", fontSize: 13, fontWeight: 800, fontFamily: FT, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 7, boxShadow: "0 4px 14px rgba(230,57,70,.3)" }}><Lock size={15} />Pay Now — SGD {bill.total.toFixed(2)}</button>
            <button onClick={function() { setAct("res"); }} style={{ padding: "11px 0", borderRadius: 10, border: "2px solid " + N, background: "#fff", color: N, fontSize: 12, fontWeight: 800, fontFamily: FT, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}><CreditCard size={13} />Reserve SGD 50</button>
