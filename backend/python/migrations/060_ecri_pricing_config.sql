...
VALUES (
    ...
    jsonb_build_object(
        ...
        'factors', jsonb_build_object(
            'below_market',          jsonb_build_object('enabled', true, 'weight',  1.0),
            'below_site_median',     jsonb_build_object('enabled', true, 'weight',  0.7),
            'below_country_median',  jsonb_build_object('enabled', true, 'weight',  0.5),
            'below_top3',            jsonb_build_object('enabled', true, 'weight',  0.6),
            'below_top1',            jsonb_build_object('enabled', true, 'weight',  0.4),
            'above_market',          jsonb_build_object('enabled', true, 'weight', -0.6),
            'above_site_median',     jsonb_build_object('enabled', true, 'weight', -0.4),
            'above_country_median',  jsonb_build_object('enabled', true, 'weight', -0.3),
            'above_top3',            jsonb_build_object('enabled', true, 'weight', -0.5),
            'above_top1',            jsonb_build_object('enabled', true, 'weight', -0.7),
            'high_unit_risk',        jsonb_build_object('enabled', true, 'weight', -1.0),
            'very_high_unit_risk',   jsonb_build_object('enabled', true, 'weight', -1.5),
            'tenure_under_24mo',     jsonb_build_object('enabled', true, 'weight', -0.3),
